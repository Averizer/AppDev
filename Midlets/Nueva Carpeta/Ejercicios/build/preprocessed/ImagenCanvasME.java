...
public class ImagenCanvasME extends MIDlet implements CommandListener {
    ...
    /**
     * The ImagenCanvasME constructor.
     */
    public ImagenCanvasME() {
        ...
        ca = new Canvas() {
            ...
            public void paint(Graphics g) {
                ...
                g.fillRect(0, 0, w, h);
                try {
                    Image i = Image.createImage("/mifoto.jpg");
                    g.drawImage(i, w / 2, h / 2, (Graphics.VCENTER
                            | Graphics.HCENTER));
                } catch (java.io.IOException e) {
                    g.setColor(255, 255, 255);
                    g.setStrokeStyle(Graphics.SOLID);
                    g.drawString("Error al leer java.png", 0, h / 2,
                            (Graphics.BASELINE | Graphics.LEFT));
                }
            }
        };
        c = new Command("Salir", Command.SCREEN, 3);
        ca.addCommand(c);
