...
class Obj{	
	...
	vScr	= new Point2D[8];
                                                            //Cubo                  Piramide                                                              
        w[0]	= new Point3D(1, -1, -1);   //                1, -1, -1  desde la base 0, 0, -2
	w[1]	= new Point3D(1, 1, -1);   //                1, 1, -1                 0, 0, -2
	w[2]	= new Point3D(-1, 1, -1);   //               -1, 1, -1                 0, 0, -2
	w[3]	= new Point3D(-1, -1, -1);   //               -1, -1, -1                0, 0, -2
	w[4]	= new Point3D(1, -1, 1);   //                1, -1, 1                 1, -1, 1  
	w[5]	= new Point3D(1, 1, 1);    //                1, 1, 1                  1, 1, 1  
        w[6]	= new Point3D(-1, 1, 1);   //               -1, 1, 1                 -1, 1, 1
	w[7]	= new Point3D(-1, -1, 1);  //               -1, -1, 1                -1, -1, 1 
