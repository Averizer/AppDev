 ...
 */
public class Numero_Maravilloso extends MIDlet implements CommandListener {
...
//</editor-fold>//GEN-END:|fields|0|
     ...
     */
    public Numero_Maravilloso() {
        
        //number = Integer.parseInt(tx.getString());
    }
...
//</editor-fold>//GEN-END:|16-getter|2|
    ...
    public void startApp() {
         TextBox tx;
        tx = new TextBox("Mensaje","",256,TextField.NUMERIC);
        System.out.println("TextBox: "+tx.isShown()); 
