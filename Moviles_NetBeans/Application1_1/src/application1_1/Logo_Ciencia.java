 ...
 */
public class Logo_Ciencia extends MIDlet implements CommandListener {
...
//</editor-fold>//GEN-END:|16-getter|2|
    ...
    class DrawingDemoCanvas extends Canvas {
        protected void paint(Graphics g) {
			...
			g.fillRoundRect(x,x,y,y,z,z);
			L=(y-x);
			//System.out.println("x: "+x);
			j=(int)(((2*Math.sqrt(2)*y)/4)-(y/2));
			intersec=(int)Math.sqrt((j*j)/2);
